...
df_filer_new = df_filter_new.withColumn('dim_date_key', max_value + F.monotonically_increasing_id())
...
# Incremental RUN 
if spark.catalog.tableExists('cars_catalog.gold.dim_date'):
    delta_table = DeltaTable.forPath(spark, "abfss://gold@datalakecarsale.dfs.core.windows.net/dim_date")
...
# Initial RUN 
    ...
    df_final.write.format("delta")\
        .mode("overwrite")\
        .option("path", "abfss://gold@datalakecarsale.dfs.core.windows.net/dim_date")\
